    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" id="formGroupExampleInput" name="title" placeholder="Input Title">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('content') is-invalid @enderror" id="formGroupExampleInput" name="content" placeholder="Input Content">
                @error('content')
                <div class="invalid-feedback">
                    {{ $message }}
                  </div>
